...
public class StockPriceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void init() {
        mPriceLinePaint = new Paint();
            ...
            mPriceLinePaint.setStrokeWidth(3);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        mGameThread = new GameThread(getHolder(), this, new SmoothMarket(mCurStockPrice, mHeight), mGameActivity.server); //Start the thread that
    ...
    public void onDraw(Canvas c) {
        ...
        c.save();
        c.translate(-mCurTime + c.getWidth() - 20, 100);
